...
Scenario: View filled torrents page
    ...
    Then I see an overview of the following torrents
        ...
        | TorrentWithTwoFiles | 0         | 0.02          | 0                 | /downloads/complete | my-tracker:6969     | nonexisting-tracker:12345 |
...
Scenario: Relocate torrent data
    ...
    And the data of the following torrents is sent to the torrent client
        ...
        | TorrentWithOneFile | /downloads/complete/unmapped |
...
Scenario: Relocate torrent data with different extensions
    ...
    And the data of the following torrents is sent to the torrent client
        | TorrentName                   | TargetLocation               |
        | TorrentWithOneFile            | /downloads/complete/unmapped |
        | TorrentWithDifferentExtension | /downloads/complete/unmapped |
    And I navigate to the torrent overview
    When I open the relocate data dialog for the following torrents
        | Name                          |
        | TorrentWithOneFile            |
    ...
    Then I see an overview of the following torrents
        | Name                          | LocationOnDisk               | GBsOnDisk |
        | TorrentWithOneFile            | /downloads/complete/unmapped | 0         |
        | TorrentWithDifferentExtension | /downloads/complete/unmapped | 0         |
...
Scenario: Relocate torrent data with multi dir torrents
    ...
    And the data of the following torrents is sent to the torrent client
        | TorrentName                        | TargetLocation                |
        | TorrentWithOneFile                 | /downloads/complete/unmapped  |
        | TorrentWithTwoFiles                | /downloads/complete/unmapped2 |
        | TorrentWithTwoFilesInADir          | /downloads/complete/unmapped  |
        | TorrentWithTwoFilesInDifferentDirs | /downloads/complete/unmapped  |
    And I navigate to the torrent overview
    When I open the relocate data dialog for the following torrents
        | Name                               |
        | TorrentWithOneFile                 |
    ...
    Then I see an overview of the following torrents
        | Name                               | LocationOnDisk                | GBsOnDisk |
        | TorrentWithOneFile                 | /downloads/complete/unmapped  | 0         |
        | TorrentWithTwoFiles                | /downloads/complete/unmapped2 | 0         |
        | TorrentWithTwoFilesInADir          | /downloads/complete/unmapped  | 0         |
        | TorrentWithTwoFilesInDifferentDirs | /downloads/complete/unmapped  | 0         |