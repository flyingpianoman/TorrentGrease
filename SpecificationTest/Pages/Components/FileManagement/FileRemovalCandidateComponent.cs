...
{
    internal class FileRemovalCandidateComponent : IComponent<FileRemovalCandidateComponent>
    {
        ...
        public FileRemovalCandidateComponent(IWebElement rootElement, IWebDriver webDriver)
        {
            _rootElement  = rootElement;
            _webDriver = webDriver;
        }

        public Task<FileRemovalCandidateComponent> InitializeAsync()
        {
