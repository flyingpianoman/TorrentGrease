...
namespace TorrentGrease.GrpcClient
{
    ...
    public class GrpcWebCallInvoker : CallInvoker
    {
        ...
        {
            var call = new GrpcWebCall<TRequest, TResponse>(_httpClient, method, request);
        ...
        private class GrpcWebCall<TRequest, TResponse>
        {
            ...
            public GrpcWebCall(HttpClient httpClient, Method<TRequest, TResponse> method, TRequest request)
            {
